...
export const LandingAuthPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#EEF4FB] dark:bg-[#070a11] flex flex-col items-center justify-center p-4 relative overflow-y-auto font-sans text-slate-800 dark:text-gray-100 select-none">
      
      <main className="w-full max-w-sm z-10 my-4">
        
        {/* Main Clean White Card with soft shadow */}
        <div className="bg-white dark:bg-[#0e1524] border border-slate-200/80 dark:border-white/10 rounded-[36px] p-6 sm:p-7 shadow-[0_20px_50px_rgba(0,0,0,0.06)] dark:shadow-2xl space-y-5 relative overflow-hidden transition-all">
              ...
              <div className="pt-2 text-center space-y-3">
                ...
                <div className="flex items-center justify-center gap-3.5 pt-1">
                  ...
                  <button
                    ...
                    className="w-12 h-12 rounded-full border border-slate-200 dark:border-white/10 bg-white dark:bg-[#131c30] flex items-center justify-center hover:border-slate-300 transition-all shadow-sm"
                  ...
                  <button
                    ...
                    className="w-12 h-12 rounded-full border border-slate-200 dark:border-white/10 bg-white dark:bg-[#131c30] flex items-center justify-center hover:border-slate-300 transition-all shadow-sm text-[#1877F2]"
